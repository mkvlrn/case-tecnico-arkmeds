...
import type { GetByIdBaseUserUseCase } from "@/domain/shared/get-base-user-by-id.usecase";

export abstract class GetBaseUserByIdController<
  TModel extends BaseUser,
  TRepository extends BaseUserRepository<TModel>,
  TUseCase extends GetByIdBaseUserUseCase<TModel, TRepository>,
> {
