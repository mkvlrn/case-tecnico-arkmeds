  ...
  fail: [
    ...
    // ===== cpf conflict validation =====
    {
      ...
      error: {
        ...
        message: `driver with cpf ${strip("729.359.300-70")} already exists`,
      },
    },
    ...
    },
    {
      ...
      id: "okmclejrj1xegofrbc164ie0",
      input: { ...validUpdateInput, dateOfBirth: "01/01/1999" },
      statusCode: StatusCodes.UNPROCESSABLE_ENTITY,
      error: {
        code: "invalidInput",
        message: "input/query is invalid or incomplete",
    ...
    },
    {
      ...
      id: "okmclejrj1xegofrbc164ie0",
      input: { ...validUpdateInput, dateOfBirth: "1999-13-01" },
      statusCode: StatusCodes.UNPROCESSABLE_ENTITY,
      error: {
        code: "invalidInput",
        message: "input/query is invalid or incomplete",
    ...
    },
    {
      ...
      id: "okmclejrj1xegofrbc164ie0",
      input: { ...validUpdateInput, dateOfBirth: "1999-01-32" },
      statusCode: StatusCodes.UNPROCESSABLE_ENTITY,
      error: {
        code: "invalidInput",
        message: "input/query is invalid or incomplete",
    ...
    },
    {
      ...
      id: "okmclejrj1xegofrbc164ie0",
      input: { ...validUpdateInput, dateOfBirth: 19_990_101 },
      statusCode: StatusCodes.UNPROCESSABLE_ENTITY,
      error: {
        code: "invalidInput",
        message: "input/query is invalid or incomplete",
    ...
    // ===== vehicle validation =====
    {
      ...
      id: "okmclejrj1xegofrbc164ie0",
      input: { ...validUpdateInput, vehicle: undefined },
      statusCode: StatusCodes.UNPROCESSABLE_ENTITY,
      error: {
        code: "invalidInput",
        message: "input/query is invalid or incomplete",
    ...
    },
    {
      ...
      id: "okmclejrj1xegofrbc164ie0",
      input: { ...validUpdateInput, vehicle: "Car" },
      statusCode: StatusCodes.UNPROCESSABLE_ENTITY,
      error: {
        code: "invalidInput",
        message: "input/query is invalid or incomplete",
    ...
    },
    {
      ...
      id: "okmclejrj1xegofrbc164ie0",
      input: { ...validUpdateInput, vehicle: "A".repeat(256) },
      statusCode: StatusCodes.UNPROCESSABLE_ENTITY,
      error: {
        code: "invalidInput",
        message: "input/query is invalid or incomplete",
    ...
    },
    {
      ...
      id: "okmclejrj1xegofrbc164ie0",
      input: { ...validUpdateInput, vehicle: 2021 },
      statusCode: StatusCodes.UNPROCESSABLE_ENTITY,
      error: {
        code: "invalidInput",
        message: "input/query is invalid or incomplete",
